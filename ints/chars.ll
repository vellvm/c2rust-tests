...
define i32 @multibyte_chars(i32 noundef %0, i32* nocapture noundef writeonly %1) local_unnamed_addr #0 {
  %3 = bitcast i32* %1 to <4 x i32>*
  store <4 x i32> <i32 10003, i32 128561, i32 128561, i32 0>, <4 x i32>* %3, align 4, !tbaa !5
