; ModuleID = './cast_funptr.c'
source_filename = "./cast_funptr.c"
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind readnone sspstrong uwtable willreturn
define i8* @get_identity() local_unnamed_addr #0 {
  ret i8* bitcast (i32 (i32)* @identity to i8*)
}
...
define void @entry(i32 noundef %0, i32* nocapture noundef writeonly %1) local_unnamed_addr #1 {
  ...
  store i32 ptrtoint (i32 (i32)* @identity to i32), i32* %3, align 4, !tbaa !5
  ret void
}
