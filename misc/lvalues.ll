; ModuleID = './lvalues.c'
source_filename = "./lvalues.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: mustprogress nofree norecurse nosync nounwind readnone sspstrong uwtable willreturn
define i32* @foo(i32* noundef readnone %0) local_unnamed_addr #0 {
  %2 = getelementptr i32, i32* %0, i64 1
  ret i32* %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind readnone sspstrong uwtable willreturn
define i32 @bar(i32 noundef %0) local_unnamed_addr #0 {
  %2 = add i32 %0, 1
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong uwtable willreturn writeonly
define void @lvalue(i32* nocapture noundef writeonly %0) local_unnamed_addr #1 {
  %2 = bitcast i32* %0 to <4 x i32>*
  store <4 x i32> <i32 8, i32 9, i32 3, i32 6>, <4 x i32>* %2, align 4, !tbaa !5
  %3 = getelementptr i32, i32* %0, i64 4
  store i32 7, i32* %3, align 4, !tbaa !5
  %4 = getelementptr i32, i32* %0, i64 5
